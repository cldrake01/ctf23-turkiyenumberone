...
public class BoundedGrid<E> extends AbstractGrid<E> {
  ...
  /**
   * Constructs an empty bounded grid with the given dimensions. (Precondition: <code>rows > 0
   * </code> and <code>cols > 0</code>.)
   *
  ...
  public E get(Location loc) {
    if (!isValid(loc)) throw new IllegalArgumentException("Location " + loc + " is not valid");
