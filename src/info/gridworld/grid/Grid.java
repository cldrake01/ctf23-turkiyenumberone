...
public interface Grid<E> {
   ...
   * Precondition: (1) <code>loc</code> is valid in this grid (2) <code>obj</code> is not <code>null
   * </code>
   *
   ...
   *
   * @param loc a location in this grid
   * @return returns an array list of the objects in the occupied locations adjacent to <code>loc
   *     </code> in this grid
   */
